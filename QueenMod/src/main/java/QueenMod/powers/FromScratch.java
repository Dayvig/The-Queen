...
public class FromScratch extends AbstractPower implements CloneablePowerInterface {
    ...
    public FromScratch(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new FromScratch(owner, source, amount);
    }
}
