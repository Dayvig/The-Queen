...
public class SwarmPower extends AbstractPower {
    ...
    public static final String POWER_ID = QueenMod.makeID("Swarm");
    ...
    public SwarmPower(final AbstractCreature owner, final AbstractCreature source, int newAmount) {
        this.name = NAME;
    ...
    public void atEndOfTurn(boolean isPlayer) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this.owner, this.owner, new SwarmPower(this.owner, this.owner, this.amount - 1), -1));
    }
}
