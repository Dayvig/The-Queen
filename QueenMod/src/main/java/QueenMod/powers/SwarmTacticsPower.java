...
public class SwarmTacticsPower extends AbstractPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("tactics84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("tactics32.png"));
