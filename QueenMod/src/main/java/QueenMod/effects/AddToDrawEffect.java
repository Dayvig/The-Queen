...
public class AddToDrawEffect extends AbstractGameEffect {
    ...
    public AddToDrawEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset, boolean toBottom) {
    ...
    public AddToDrawEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset) {
        this(srcCard, x, y, randomSpot, cardOffset, false);
    }

    public AddToDrawEffect(AbstractCard srcCard, float x, float y, boolean randomSpot) {
        this(srcCard, x, y, randomSpot, false);
    }

    public AddToDrawEffect(AbstractCard srcCard, boolean randomSpot, boolean toBottom) {
        this.randomSpot = false;
        this.cardOffset = false;
        this.card = srcCard.makeStatEquivalentCopy();
        this.duration = 1.5F;
    ...
    private void identifySpawnLocation(float x, float y) {
        ...
        while(var4.hasNext()) {
            ...
            if (e instanceof AddToDrawEffect) {
                ++effectCount;
            }
        }
