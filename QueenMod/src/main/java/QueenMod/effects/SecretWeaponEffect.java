...
public class SecretWeaponEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public SecretWeaponEffect(float x, float y, boolean flipHorizontal) {
        if (img == null) {
    ...
    public void update() {
        if (!this.playedSfx) {
            AbstractDungeon.effectsQueue.add(new BorderLongFlashEffect(Color.YELLOW));
            this.playedSfx = true;
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.setColor(this.color.r, this.color.g, this.color.b, this.color.a);
