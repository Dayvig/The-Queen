...
public class ShowCardAddToDrawPileFast extends AbstractGameEffect {
    ...
    public ShowCardAddToDrawPileFast(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset, boolean toBottom) {
    ...
    public ShowCardAddToDrawPileFast(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset) {
        this(srcCard, x, y, randomSpot, cardOffset, false);
    }

    public ShowCardAddToDrawPileFast(AbstractCard srcCard, float x, float y, boolean randomSpot) {
        this(srcCard, x, y, randomSpot, false);
    }

    public ShowCardAddToDrawPileFast(AbstractCard srcCard, boolean randomSpot, boolean toBottom) {
        this.randomSpot = false;
        this.cardOffset = false;
        this.card = srcCard.makeStatEquivalentCopy();
        this.duration = 0.5F;
    ...
    private void identifySpawnLocation(float x, float y) {
        ...
        while(var4.hasNext()) {
            ...
            if (e instanceof ShowCardAddToDrawPileFast) {
                ++effectCount;
            }
        }
