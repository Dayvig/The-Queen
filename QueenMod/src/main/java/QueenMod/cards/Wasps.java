...
public class Wasps extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = QueenMod.makeID(Wasps.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("wasps.png");// "public static final String IMG = makeCardPath("${NAME}.png");
