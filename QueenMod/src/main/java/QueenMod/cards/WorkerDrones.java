...
public class WorkerDrones extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = QueenMod.makeID(WorkerDrones.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileActionFast(new HoneyBee(), magicNumber, true, false));
    }
