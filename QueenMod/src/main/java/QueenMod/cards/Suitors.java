...
public class Suitors extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = QueenMod.makeID(Suitors.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public Suitors() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
