...
public class InspiringStrike extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = QueenMod.makeID(InspiringStrike.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("inspire.png");// "public static final String IMG = makeCardPath("${NAME}.png");
