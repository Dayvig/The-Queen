...
public class SwarmingStrike extends AbstractDynamicCard {
    ...
    public SwarmingStrike() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
