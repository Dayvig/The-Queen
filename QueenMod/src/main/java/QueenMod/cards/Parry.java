...
public class Parry extends AbstractDynamicCard {
    ...
    public static final String ID = QueenMod.makeID(Parry.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("parry.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInHandAction(new Riposte(this.upgraded), 1));
    }
