...
public class DignifiedSlap extends AbstractDynamicCard {
    ...
    public static final String IMG = makeCardPath("slap.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        CardCrawlGame.sound.playA("SLAP", (float)Math.random()*0.5F);
